...
<form action="/Hitick/members-in-group" method="get" onsubmit="return validateRadio()">
		<table>
...
<c:if test="${listOfGroupsSize==0 }">
<h3>Sorry, you are not the Member of any group presently, You can only view the details of groups you are member of.!!</h3>
<br><br>
